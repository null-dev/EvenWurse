...
public abstract class AbstractComponentUI<T extends Component> implements ComponentUI {
    ...
    public void render(Component component) {
        ...
        if (!handledComponentClass.isInstance(component)) throw new IllegalArgumentException();
    ...
    public Rectangle getChildRenderArea(Container container) {
        if (!Container.class.isAssignableFrom(handledComponentClass)) throw new UnsupportedOperationException();
        if (container == null) throw new NullPointerException();
        if (!handledComponentClass.isInstance(container)) throw new IllegalArgumentException();
