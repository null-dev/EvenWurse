    ...
    public void reposition(Rectangle area, Rectangle[] componentAreas, Constraint[][] constraints) {
        ...
        for (int row = 0; row < componentsPerColumn; row++) {
            for (int element = 0; element < componentsPerRow; element++) {
                ...
                if (index >= componentAreas.length) break rowLabel;
                ...
                switch (horizontalAlign) {
                    ...
                    case CENTER:
                        componentArea.x =
                                (int) (area.x + element * elementWidth + elementWidth / 2 - componentArea.width / 2);
                        break;
                }
                switch (verticalAlign) {
                    ...
                    case CENTER:
                        componentArea.y =
                                (int) (area.y + row * elementHeight + elementHeight / 2 - componentArea.height / 2);
                        break;
                }
            }
        }
