...
public abstract class GuiWurstSlot
{
    ...
    public void drawScreen(int p_148128_1_, int p_148128_2_, float p_148128_3_)
    {
        ...
        wr.addVertexWithUV((double)this.field_148152_e, (double)this.field_148154_c, 0.0D, (double)((float)this.field_148152_e / var16), (double)((float)(this.field_148154_c + (int)this.field_148169_q) / var16));
        wr.addVertexWithUV((double)this.field_148151_d, (double)this.field_148154_c, 0.0D, (double)((float)this.field_148151_d / var16), (double)((float)(this.field_148154_c + (int)this.field_148169_q) / var16));
        wr.addVertexWithUV((double)this.field_148151_d, (double)this.field_148153_b, 0.0D, (double)((float)this.field_148151_d / var16), (double)((float)(this.field_148153_b + (int)this.field_148169_q) / var16));
        wr.addVertexWithUV((double)this.field_148152_e, (double)this.field_148153_b, 0.0D, (double)((float)this.field_148152_e / var16), (double)((float)(this.field_148153_b + (int)this.field_148169_q) / var16));
        ts.draw();
