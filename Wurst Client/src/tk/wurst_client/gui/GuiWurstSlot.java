...
public abstract class GuiWurstSlot {
    ...
    protected void func_148133_a(boolean p_148133_1_, int p_148133_2_) {
        ...
        if (!p_148133_1_) field_148160_j = 0;
    }
    ...
    private void func_148121_k() {
        ...
        if (!field_148163_i && var1 < 0) var1 = 0;

        if (field_148169_q < 0.0F) field_148169_q = 0.0F;

        if (field_148169_q > var1) field_148169_q = var1;
    }
    ...
    public void drawScreen(int p_148128_1_, int p_148128_2_, float p_148128_3_) {
        ...
        if (p_148128_1_ > field_148152_e && p_148128_1_ < field_148151_d && p_148128_2_ > field_148153_b &&
            ...
            if (Mouse.isButtonDown(0) && func_148125_i()) {
                if (field_148157_o == -1.0F) {
                    ...
                    if (p_148128_2_ >= field_148153_b && p_148128_2_ <= field_148154_c) {
                        ...
                        if (p_148128_1_ >= var8 && p_148128_1_ <= var9 && var11 >= 0 && var10 >= 0 && var11 < var4) {
                            boolean var12 =
                                    var11 == field_148168_r && Minecraft.getSystemTime() - field_148167_s < 250L;
                ...
                try {
                    for (; !field_148161_k.gameSettings.touchscreen && Mouse.next();
                         field_148161_k.currentScreen.handleMouseInput()) {
        ...
        if (field_148165_u) func_148129_a(var9, var10, Tessellator.getInstance());
        ...
        if (var19 > 0) {
            ...
            if (var13 > field_148154_c - field_148153_b - 8) var13 = field_148154_c - field_148153_b - 8;

            int var14 = (int) field_148169_q * (field_148154_c - field_148153_b - var13) / var19 + field_148153_b;

            if (var14 < field_148153_b) var14 = field_148153_b;
