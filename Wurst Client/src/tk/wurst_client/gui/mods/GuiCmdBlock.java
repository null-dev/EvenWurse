...
public class GuiCmdBlock extends GuiScreen {
    ...
    public void initGui() {
        ...
        buttonList.add(new GuiButton(0, width / 2 - 100, height / 3 * 2, 200, 20, "Done"));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredString(fontRendererObj, "executed by the Command Block.", width / 2, 110, 10526880);
