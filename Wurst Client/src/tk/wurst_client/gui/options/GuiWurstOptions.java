...
public class GuiWurstOptions extends GuiScreen
{
    ...
    public void initGui()
    {
    	this.autoMaximize = Client.Wurst.fileManager.loadAutoResize();
        ...
        this.buttonList.add(new GuiButton(4, this.width / 2 - 154, this.height / 4 + 96 - 16, 100, 20, "AutoMaximize: " + (this.autoMaximize ? "ON" : "OFF")));
        ...
        ((GuiButton)this.buttonList.get(4)).enabled = !Minecraft.isRunningOnMac;
    }
    ...
    protected void actionPerformed(GuiButton clickedButton)
    {
		if(clickedButton.enabled)
        {
            ...
            {//AutoMaximize
            	...
            	Client.Wurst.fileManager.saveAutoMaximize(this.autoMaximize);
