...
public class GuiConfigEntryManager extends GuiScreen {
    ...
    public void initGui() {
        ...
        buttonList.add(new GuiButton(2, width / 2 - 100, height - 28, 98, 20, "Add"));
        buttonList.add(new GuiButton(3, width / 2 + 2, height - 28, 98, 20, "Back"));
    }
    ...
    protected void actionPerformed(GuiButton clickedButton) {
        if (clickedButton.enabled) {
            ...
            } else if (clickedButton.id == 3) mc.displayGuiScreen(prevMenu);
        }
    }
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        drawCenteredString(fontRendererObj, ModuleUtils.getModuleName(module) + " Configuration", width / 2, 8,
                16777215);
        drawCenteredString(fontRendererObj,
                "Total Configurable Entries: " + ModuleConfiguration.forModule(module).getConfig().size(), width / 2,
                20, 16777215);
