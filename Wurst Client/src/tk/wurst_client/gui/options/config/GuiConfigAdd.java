...
public class GuiConfigAdd extends GuiScreen
{
	...
	public void updateScreen()
	{
		...
		((GuiButton)buttonList.get(0)).enabled =
				keyBox.getText().trim().length() > 0 && !entryExists();
	}
	...
	public void initGui()
	{
		...
		valueBox =
				new GuiTextField(0, fontRendererObj, width / 2 - 100, 120, 200, 20);
	}
	...
	public void drawScreen(int par1, int par2, float par3)
	{
		...
		drawCenteredString(fontRendererObj, ModuleUtils.getModuleName(module) + ": Add Configuration Entry", width / 2, 20,
				16777215);
