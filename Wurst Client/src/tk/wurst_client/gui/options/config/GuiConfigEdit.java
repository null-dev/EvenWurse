...
public class GuiConfigEdit extends GuiScreen {
    ...
    public void initGui() {
        ...
        buttonList.clear();
        buttonList.add(new GuiButton(0, width / 2 - 100, height / 4 + 120 + 12, "Edit"));
        buttonList.add(new GuiButton(1, width / 2 - 100, height / 4 + 144 + 12, "Cancel"));
        valueBox = new GuiTextField(0, fontRendererObj, width / 2 - 100, 80, 200, 20);
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        int x = width / 2 - 9;
        int y = height / 2 - 32;
        drawCenteredString(fontRendererObj, ModuleUtils.getModuleName(module) + ": Edit Entry '" + key + "'", width / 2,
                20, 16777215);
