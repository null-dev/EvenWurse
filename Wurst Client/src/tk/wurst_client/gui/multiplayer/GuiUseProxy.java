...
public class GuiUseProxy extends GuiScreen {
    ...
    public void initGui() {
        ...
        buttonList.clear();
        buttonList.add(new GuiButton(0, width / 2 - 100, height / 4 + 120 + 12, "Cancel"));
        buttonList.add(new GuiButton(1, width / 2 - 100, height / 4 + 72 + 12, "Connect"));
        buttonList.add(new GuiButton(2, width / 2 - 100, height / 4 + 96 + 12, "Reset"));
        ...
        if (clickedButton.enabled) {
            if (clickedButton.id == 0) {// Cancel
                ...
                if (error.isEmpty()) {
                    ...
                    WurstClient.INSTANCE.analytics.trackEvent("use proxy", "error", error);
                }
            } else if (clickedButton.id == 2) {// Reset
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        drawCenteredString(fontRendererObj, "Use Proxy", width / 2, 20, 0xFFFFFF);
        drawString(fontRendererObj, "IP:Port (must be a SOCKS proxy)", width / 2 - 100, 47, 0xA0A0A0);
        ...
        if (currentProxy.equals(":") || currentProxy.equals("null:null")) currentProxy = "none";
