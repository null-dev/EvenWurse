...
public class GuiEmailField extends Gui {
    ...
    public GuiEmailField(int p_i45542_1_, FontRenderer p_i45542_2_, int p_i45542_3_, int p_i45542_4_, int p_i45542_5_,
                         int p_i45542_6_) {
    ...
    public void writeText(String p_146191_1_) {
        ...
        if (text.length() > 0) var2 = var2 + text.substring(0, var4);
        ...
        if (text.length() > 0 && var5 < text.length()) var2 = var2 + text.substring(var5);

        if (field_175209_y.apply(var2)) {
            text = var2;
            moveCursorBy(var4 - selectionEnd + var8);

            if (field_175210_x != null) field_175210_x.func_175319_a(field_175208_g, text);
        }
    }
    ...
    public void deleteFromCursor(int p_146175_1_) {
        if (text.length() != 0) {
            if (selectionEnd != cursorPosition) {
                ...
                if (var3 >= 0) var5 = text.substring(0, var3);

                if (var4 < text.length()) var5 = var5 + text.substring(var4);

                text = var5;

                if (var2) moveCursorBy(p_146175_1_);
    ...
    public int func_146197_a(int p_146197_1_, int p_146197_2_, boolean p_146197_3_) {
        ...
        for (int var7 = 0; var7 < var6; ++var7) {
            if (var5) {
                while (p_146197_3_ && var4 > 0 && text.charAt(var4 - 1) == 32) --var4;

                while (var4 > 0 && text.charAt(var4 - 1) != 32) --var4;
            } else {
                ...
                if (var4 == -1) {
                    ...
                    while (p_146197_3_ && var4 < var8 && text.charAt(var4) == 32) ++var4;
                }
            }
        }
    ...
    public void mouseClicked(int p_146192_1_, int p_146192_2_, int p_146192_3_) {
        boolean var4 = p_146192_1_ >= xPosition && p_146192_1_ < xPosition + width && p_146192_2_ >= yPosition &&
                p_146192_2_ < yPosition + height;

        if (canLoseFocus) setFocused(var4);

        if (isFocused && var4 && p_146192_3_ == 0) {
            int var5 = p_146192_1_ - xPosition;

            if (enableBackgroundDrawing) var5 -= 4;
    ...
    public void drawTextBox() {
        if (getVisible()) {
            ...
            if (var4.length() > 0 && var5 && var2 < var4.length()) {
                fontRendererInstance.drawStringWithShadow(var4.substring(var2), var9, var8, var1);
            }
    ...
    private void drawCursorVertical(int p_146188_1_, int p_146188_2_, int p_146188_3_, int p_146188_4_) {
        ...
        if (p_146188_3_ > xPosition + width) p_146188_3_ = xPosition + width;

        if (p_146188_1_ > xPosition + width) p_146188_1_ = xPosition + width;
    ...
    public void setMaxStringLength(int p_146203_1_) {
        ...
        if (text.length() > p_146203_1_) text = text.substring(0, p_146203_1_);
    }
    ...
    public void setFocused(boolean p_146195_1_) {
        if (p_146195_1_ && !isFocused) cursorCounter = 0;
    ...
    public void setSelectionPos(int p_146199_1_) {
        ...
        if (fontRendererInstance != null) {
            if (lineScrollOffset > var2) lineScrollOffset = var2;
            ...
            } else if (p_146199_1_ <= lineScrollOffset) lineScrollOffset -= lineScrollOffset - p_146199_1_;
