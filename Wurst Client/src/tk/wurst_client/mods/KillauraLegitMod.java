...
public class KillauraLegitMod extends Mod implements UpdateListener {
    ...
    public void onUpdate() {
        ...
        if (hasTimePassedS(WurstClient.INSTANCE.mods.getModByClass(KillauraMod.class).yesCheatSpeed) && en != null) {
            if (Minecraft.getMinecraft().thePlayer.getDistanceToEntity(en) <=
                    WurstClient.INSTANCE.mods.getModByClass(KillauraMod.class).yesCheatRange) {
