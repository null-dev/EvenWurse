...
@Info(category = Category.RENDER,
        ...
        name = "PlayerFinder")
public class PlayerFinderMod extends Mod implements PacketInputListener, RenderListener {
    ...
    public void onRender() {
        ...
        float green =
                (1F - (float) Math.sin((float) ((System.currentTimeMillis() + 333L) % 1000L) / 1000L * Math.PI * 2)) /
                        2F;
        float blue =
                (1F - (float) Math.sin((float) ((System.currentTimeMillis() + 666L) % 1000L) / 1000L * Math.PI * 2)) /
                        2F;
    ...
    public void onReceivedPacket(PacketInputEvent event) {
        ...
        if (packet instanceof S28PacketEffect) {
            ...
            if (BlockUtils.getPlayerBlockDistance(pos) >= 160) blockPos = pos;
            ...
            BlockPos pos = new BlockPos(lightning.func_149051_d() / 32D, lightning.func_149050_e() / 32D,
