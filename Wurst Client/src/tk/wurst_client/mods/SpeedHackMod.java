...
public class SpeedHackMod extends Mod implements UpdateListener {
    ...
    public void onUpdate() {
        ...
        if (Minecraft.getMinecraft().thePlayer.isSneaking() || (Minecraft.getMinecraft().thePlayer.moveForward == 0 &&
        ...
        if (Minecraft.getMinecraft().thePlayer.onGround) {
            ...
            double currentSpeed = Math.sqrt(Math.pow(Minecraft.getMinecraft().thePlayer.motionX, 2) +
            ...
            if (currentSpeed > maxSpeed) {
                Minecraft.getMinecraft().thePlayer.motionX =
                        Minecraft.getMinecraft().thePlayer.motionX / currentSpeed * maxSpeed;
                Minecraft.getMinecraft().thePlayer.motionZ =
                        Minecraft.getMinecraft().thePlayer.motionZ / currentSpeed * maxSpeed;
            }
        }
    }
