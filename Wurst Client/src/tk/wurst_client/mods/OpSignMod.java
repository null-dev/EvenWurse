...
public class OpSignMod extends Mod {
    ...
    public void onEnable() {
        Minecraft.getMinecraft().displayGuiScreen(new GuiOpSign(this, Minecraft.getMinecraft().currentScreen));
    }

    public void setCommand(String cmd) {
        command = cmd.replace("\"", "\\\\\"");
        WurstClient.INSTANCE.chat.message("Command set. Place & right click a sign to run it.");
    }
}
