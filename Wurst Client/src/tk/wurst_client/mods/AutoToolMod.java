...
public class AutoToolMod extends Mod implements LeftClickListener, UpdateListener {
    ...
    public static void setSlot(BlockPos blockPos) {
        ...
        if (bestSlot != -1) Minecraft.getMinecraft().thePlayer.inventory.currentItem = bestSlot;
    }
    ...
    public void onUpdate() {
        ...
        } else if (isActive && Minecraft.getMinecraft().objectMouseOver != null &&
    ...
    public NavigatorItem[] getSeeAlso() {
        ...
        return new NavigatorItem[]{wurst.mods.getModByClass(AutoSwordMod.class)};
    }
    ...
    public void onLeftClick() {
        ...
        if (Minecraft.getMinecraft().theWorld.getBlockState(Minecraft.getMinecraft().objectMouseOver.getBlockPos())
                .getBlock().getMaterial() != Material.air) {
            isActive = true;
