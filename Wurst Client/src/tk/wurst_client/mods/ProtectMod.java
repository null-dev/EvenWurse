...
public class ProtectMod extends Mod implements UpdateListener {
    ...
    public void onEnable() {
        ...
        if (en != null && Minecraft.getMinecraft().thePlayer.getDistanceToEntity(en) <= RANGE) friend = en;
    ...
    public void onUpdate() {
        ...
        if (enemy != null && (enemy.getHealth() <= 0 || enemy.isDead)) enemy = null;
        ...
        Minecraft.getMinecraft().gameSettings.keyBindForward.pressed = (xDistF > DISTANCE_F || zDistF > DISTANCE_F) &&
                (enemy == null || Minecraft.getMinecraft().thePlayer.getDistanceToEntity(enemy) > RANGE) ||
                xDistE > DISTANCE_E || zDistE > DISTANCE_E;
    ...
    public void onDisable() {
        ...
        if (friend != null) Minecraft.getMinecraft().gameSettings.keyBindForward.pressed = false;
    }
