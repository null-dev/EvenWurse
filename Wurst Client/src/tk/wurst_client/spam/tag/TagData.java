...
public class TagData {
    ...
    private String spam;
    public TagData(int tagStart, int tagLength, int tagLine, String tagName, String[] tagArgs, boolean tagClosed,
                   String tag, String tagContent, int tagContentLength, String spam) {
