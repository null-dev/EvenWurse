...
@Info(help = "Manages your friends list.", name = "friends", syntax = {"(add | remove) <player>", "list [<page>]"})
    ...
    public void execute(String[] args) throws Error {
        ...
        if (args[0].equalsIgnoreCase("list")) {
            ...
            if (MiscUtils.isInteger(args[1])) {
                ...
                if (page > pages || page < 1) syntaxError();
                ...
                for (int i = 0; itr.hasNext(); i++) {
                    ...
                    if (i >= (page - 1) * 8 && i < (page - 1) * 8 + 8) WurstClient.INSTANCE.chat.message(friend);
                }
            } else {
                syntaxError();
            }
