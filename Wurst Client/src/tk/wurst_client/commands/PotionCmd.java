...
@Info(help = "Changes the effects of the held potion.",
        name = "potion",
        syntax = {"add (<effect> <amplifier> <duration>)...", "set (<effect> <amplifier> <duration>)...",
                "remove <effect>"})
public class PotionCmd extends Cmd {
    ...
    public void execute(String[] args) throws Error {
        ...
        // remove
        if (args.length == 2) {
            if (!args[0].equalsIgnoreCase("Remove")) syntaxError();
            int id;
            ...
            return;
        } else if ((args.length - 1) % 3 != 0) syntaxError();
        ...
        } else if (!args[0].equalsIgnoreCase("set")) syntaxError();
