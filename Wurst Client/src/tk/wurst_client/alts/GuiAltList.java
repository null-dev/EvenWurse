...
public class GuiAltList extends GuiWurstSlot
{
	...
	protected void drawSlot(int id, int x, int y, int var4, int var5, int var6)
	{
		...
		this.mc.fontRendererObj.drawString("Name: " + alt.name, x + 31, y + 3, 10526880);
		String stars = "";
		for(int i = 0; i < alt.password.length(); i++)
			stars = stars.concat("*");
		this.mc.fontRendererObj.drawString((alt.cracked ? "cracked" : "Password: " + stars), x + 31, y + 15, 10526880);
	}
}
