...
public class GuiAltLogin extends GuiScreen
{
	...
	private YggdrasilUserAuthentication authentication = (YggdrasilUserAuthentication)authenticationService.createUserAuthentication(Agent.MINECRAFT);
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 100, this.height / 4 + 72 + 12, "Login"));
        ...
        this.nameBox = new GuiTextField(0, this.fontRendererObj, this.width / 2 - 100, 60, 200, 20);
