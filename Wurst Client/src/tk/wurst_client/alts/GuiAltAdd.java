...
public class GuiAltAdd extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 100, this.height / 4 + 72 + 12, "Add"));
    ...
    protected void actionPerformed(GuiButton clickedButton)
    {
        if (clickedButton.enabled)
        {
            ...
            {//Add
            	...
            	{//Cracked
            		GuiAlts.altList.alts.add(new Alt(nameBox.getText(), null));
            		displayText = "";
            	}else
            	{//Premium
            		...
            		{
            			GuiAlts.altList.alts.add(new Alt(nameBox.getText(), passwordBox.getText()));
            		}
            	}
            	if(displayText.equals(""))
            	{
