...
public class AStar {
                ...
                for (byte z = -1; z <= 1; z++) {
                    ...
                    if (x != 0 && z != 0 && (y == 0 || y == 1)) {
                        ...
                        Tile xOff = new Tile((short) (current.getX() + x), (short) (current.getY() + y),
                                (short) (current.getZ()), current), zOff =
                                new Tile((short) (current.getX()), (short) (current.getY() + y),
                                        (short) (current.getZ() + z), current);
    ...
    private boolean isTileWalkable(Tile t) {
        ...
        return i != 10 && i != 11 && i != 51 && i != 59 && i != 65 && i != 0 && i != 85 && i != 107 && i != 113 &&
                !canBlockBeWalkedThrough(i) && BlockUtils.getID(BlockUtils.getRelative(pos, 0, 1, 0)) != 107 &&
    ...
    private boolean canBlockBeWalkedThrough(int id) {
        return (id == 0 || id == 6 || id == 50 || id == 63 || id == 30 || id == 31 || id == 32 || id == 37 ||
                id == 38 || id == 39 || id == 40 || id == 55 || id == 66 || id == 75 || id == 76 || id == 78);
    }
